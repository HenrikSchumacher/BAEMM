...
# f.close()
vertices = np.loadtxt("/HOME1/users/guests/jannr/github/BAEMM/Meshes/Spot_00093696T_V.txt").transpose()
connectivity = np.loadtxt("/HOME1/users/guests/jannr/github/BAEMM/Meshes/Sphere_00093696T_T.txt").transpose()
...
res = ret[0,:] - test_real[0,:] - 1j *test_imag[0,:]
# print(np.shape(res))
