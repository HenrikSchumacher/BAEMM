...
int main()
{
    ...
    std::ofstream fout_points_plane_2("bunny_eval_points_plane_5.txt");
    ...
    std::ofstream fout_eval_plane_2_real("bunny_eval_plane_5_4pi_real.txt");
    std::ofstream fout_eval_plane_2_imag("bunny_eval_plane_5_4pi_imag.txt");
