public:
    ...
    )
    {
        ...
        // TODO: Figure out whether the compile time spend on all these template specializations really worth it.
        // Henrik: I guess, this function is not a bottleneck at all.
