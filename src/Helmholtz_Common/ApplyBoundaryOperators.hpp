public:
    ...
    template<bool solver_modeQ = false, typename C_ext, typename I_ext>
    void ApplyBoundaryOperators_PL(
    ...
    )
    {
        ...
        std::string tag = ClassName()+"::ApplyBoundaryOperators_PL<" + ToString(solver_modeQ) +">";
        ptic(tag);
