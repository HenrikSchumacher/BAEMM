...
#include "NearFieldOperatorKernel_C.cl"                
                ...
                cl_mem d_offset = clCreateBuffer(context, CL_MEM_READ_ONLY | CL_MEM_USE_HOST_PTR,
                        sizeof(Real), &offset, &ret);
                ...
                ret = clSetKernelArg(kernel, 8, sizeof(cl_mem), (void *)&d_offset);
                ...
                ret = clReleaseMemObject(d_offset);
