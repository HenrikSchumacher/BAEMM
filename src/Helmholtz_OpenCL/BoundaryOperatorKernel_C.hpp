public:
    ...
    {
        ptic(ClassName()+"::BoundaryOperatorKernel_C");
...
#include "BoundaryOperatorKernel_C.cl"
        ...
        cl_program program = clCreateProgramWithSource(context, 1,
                (const char **)&source_str, (const std::size_t *)&source_size, &ret);
        ...
        cl_kernel kernel = clCreateKernel(program, "BoundaryOperatorKernel_C", &ret);
        ...
        ret = clSetKernelArg(kernel, 4, sizeof(cl_mem), (void *)&d_kappa);
        ret = clSetKernelArg(kernel, 5, sizeof(cl_mem), (void *)&d_coeff);
        ret = clSetKernelArg(kernel, 6, sizeof(cl_mem), (void *)&d_n);
        ret = clSetKernelArg(kernel, 7, sizeof(cl_mem), (void *)&d_wave_count);
        ...
        ptoc(ClassName()+"::BoundaryOperatorKernel_C");
