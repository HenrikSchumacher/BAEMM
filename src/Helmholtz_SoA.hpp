namespace BAEMM
{
    ...
    template<class Mesh_T, typename Real>
    class Helmholtz_SoA
    {
    public:
...
//        static constexpr Real one_over_two_pi = one / two_pi;
        ...
        Helmholtz_SoA() = delete;
        
        explicit Helmholtz_SoA( Mesh_T & M_ )
        :   M             ( M_ )
        ,   n             ( M.SimplexCount() )
...
//                Tiny::Vector<3,Real,Int> nu;
        ...
        {
            tic(ClassName()+"::Neumann_to_Dirichlet_Blocked<"+ToString(i_blk_size)+","+ToString(j_blk_size)+","+ToString(n_waves)+">");
...
//                Tiny::Vector<3,Real,Int> nu;
            ...
            toc(ClassName()+"::Neumann_to_Dirichlet_Blocked<"+ToString(i_blk_size)+","+ToString(j_blk_size)+","+ToString(n_waves)+">");
        }
        ...
        {
            tic(ClassName()+"::Neumann_to_Dirichlet_C<"+ToString(n_waves)+">");
...
//                Tiny::Vector<3,Real,Int> nu;
            ...
            toc(ClassName()+"::Neumann_to_Dirichlet_C<"+ToString(n_waves)+">");
        }
        ...
        {
            tic(ClassName()+"::Neumann_to_Dirichlet_Blocked_C<"+ToString(i_blk_size)+","+ToString(j_blk_size)+","+ToString(n_waves)+">");
...
//                Tiny::Vector<3,Real,Int> nu;
            ...
            toc(ClassName()+"::Neumann_to_Dirichlet_Blocked_C<"+ToString(i_blk_size)+","+ToString(j_blk_size)+","+ToString(n_waves)+">");
        }
    ...
    public:
        ...
        {
            return "Helmholtz_SoA<"+M.ClassName()+","+TypeName<Real>::Get()+">";
        }
