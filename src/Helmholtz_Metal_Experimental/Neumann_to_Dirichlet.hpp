public:
    ...
    {
        tic(ClassName()+"::Neumann_to_Dirichlet(...,"+ToString(block_size)+","+ToString(n_waves)+")");
...
//        {
//            wprint(ClassName()+"::Neumann_to_Dirichlet: block_size != max_threads");
//        }
...
//        valprint("SIMD group size", pipeline->threadExecutionWidth() );
        ...
        toc(ClassName()+"::Neumann_to_Dirichlet(...,"+ToString(block_size)+","+ToString(n_waves)+")");
    }
